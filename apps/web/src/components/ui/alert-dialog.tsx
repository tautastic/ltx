...
const AlertDialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn("flex flex-col-reverse gap-y-4 sm:flex-row sm:justify-end sm:gap-y-0 sm:space-x-2", className)}
    {...props}
  />
);
...
const AlertDialogAction = forwardRef<HTMLButtonElement, ButtonProps>(({ className, children, ...props }, ref) => (
