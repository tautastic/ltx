import { type User, type UserWithFollowers } from "~/schemas";
...
export const ProfileCard = ({
  ...
  const computeCardDescription = useMemo(() => {
    ...
    return null;
  }, [isFollowed, isFollowing, profileCardUser, profileOverviewUser]);
    ...
    <Card className="flex min-w-[200px] max-w-[400px] flex-1 flex-col justify-between">
      <Link href={profileUri}>
        <CardHeader className="flex flex-col items-center justify-center">
          ...
          <CardDescription className="mt-0 font-mono text-xs">
