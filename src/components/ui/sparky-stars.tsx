...
export const SparkyStars = () => {
  const commonClasses = "absolute h-2 w-2 stroke-0 transition-all duration-300 ease-spring scale-0";
  return (
    <div className="relative flex h-full items-center justify-between focus-visible:outline-none">
      ...
      <div className="absolute">
        ...
        <Star
          className={cn(
            "fill-purple-500 delay-100 group-hover:-translate-x-2 group-hover:scale-100",
            commonClasses
          )}
        />
      </div>
