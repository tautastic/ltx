    ...
    compoundVariants: [
      {
        ...
        Loading: false,
        class:
          "hover:-translate-y-0.5 active:translate-y-0 shadow-sm hover:shadow-lg active:shadow-sm",
      },
      {
        Type: "primary",
        Variant: "default",
      ...
      },
      {
        ...
        Variant: "default",
        class:
          "hover:border-black focus-visible:ring-black dark:hover:border-white dark:focus-visible:ring-gray-600",
      },
      {
        Type: "danger",
        Variant: "default",
