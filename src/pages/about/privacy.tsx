  ...
  return (
    <>
      <div className="prose prose-sm mx-auto max-w-[90ch] rounded-md bg-gray-50 p-6 text-black dark:prose-invert md:prose-base prose-headings:mb-2 dark:bg-gray-950 dark:text-gray-100 sm:my-14 sm:max-w-[70ch] sm:p-14 md:max-w-[75ch] lg:max-w-[95ch]">
        ...
        <p>
          At LTX, accessible from https://ltx.ahmedsami.xyz, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by LTX and how we use it.
        </p>
        <p>
        ...
        <p>
          LTX legal basis for collecting and using the personal information described in this
        ...
        <p>
          LTX will retain your personal information only for as long as is necessary for the
        ...
        <h2>Log Files</h2>
        <p>
          LTX follows a standard procedure of using log files. These files log visitors when they
          visit websites. All hosting companies do this and a part of hosting service&apos;s
          ...
          analyzing trends, administering the site, tracking user&apos;s movement on the website,
          and gathering demographic information.
        </p>
        <h2>Cookies and Web Beacons</h2>
        <p>
          Like any other website, LTX uses &apos;cookies&apos;. These cookies are used to store
          information including visitor&apos;s preferences, and the pages on the website that the
          visitor accessed or visited. The information is used to optimize the user&apos;s
          experience by customizing our web page content based on visitor&apos;s browser type and/or
          other information.
        </p>
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on LTX,
          which are sent directly to user&apos;s browser. They automatically receive your IP address
        ...
        <p>
          Note that LTX has no access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          LTX&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          LTX does not knowingly collect any Personal Identifiable Information from children under
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in LTX. This
